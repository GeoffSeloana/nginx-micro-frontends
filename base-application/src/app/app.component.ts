...
export class AppComponent implements OnInit {
  ...
  private mooaWithLink () {
    ...
    that.mooa.registerApplicationByLink('applicationone', '/', mooaRouter.matchRoute('applicationone'));
    that.mooa.registerApplicationByLink('applicationtwo', '/', mooaRouter.matchRoute('applicationtwo'));
    this.mooa.start();
